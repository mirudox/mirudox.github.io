...
```
/* ── BITTU WALKING CAT (paper select screen) ── */
#bittu-wrap {
  position: fixed;
  bottom: 90px;
  left: -120px;
...
/* ── BITTU MESSAGE BUBBLE (paper select) ── */
#bittu-bubble {
  position: absolute;
  bottom: 90px;
  left: 50%;
...
/* ── EXAM PEEK: BITTU TOP-RIGHT CORNER ── */
#bittu-exam-peek {
  position: fixed;
  top: -90px;
  right: 16px;
...
return `<svg class="bittu-cat" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"> <g id="bittu-tail"> <path d="M62 58 Q78 45 72 32 Q68 26 64 32 Q70 42 58 52Z" fill="#e8956d" stroke="#c97a52" stroke-width="0.8"/> </g> <ellipse cx="38" cy="55" rx="24" ry="20" fill="#f5f0e8" stroke="#e0d8cc" stroke-width="0.8"/> <ellipse cx="46" cy="58" rx="12" ry="10" fill="#e8956d" opacity="0.7"/> <ellipse cx="38" cy="32" rx="19" ry="17" fill="#f5f0e8" stroke="#e0d8cc" stroke-width="0.8"/> <ellipse cx="44" cy="28" rx="10" ry="8" fill="#e8956d" opacity="0.65"/> <polygon points="22,20 17,6 30,16" fill="#f5f0e8" stroke="#e0d8cc" stroke-width="0.8"/> <polygon points="23,19 19,9 29,17" fill="#f4a0a0" opacity="0.6"/> <polygon points="48,18 52,5 57,19" fill="#e8956d" stroke="#c97a52" stroke-width="0.8"/> <polygon points="49,18 53,9 55,18" fill="#f4a0a0" opacity="0.6"/> <g id="bittu-eye-l" style="transform-origin:30px 30px"> <ellipse cx="30" cy="30" rx="4.5" ry="4" fill="#2d1b4e"/> <ellipse cx="31.5" cy="28.5" rx="1.5" ry="1.5" fill="white" opacity="0.8"/> <path d="M25.5 30 Q30 26.5 34.5 30" fill="none" stroke="#c8a882" stroke-width="1"/> </g> <g id="bittu-eye-r" style="transform-origin:46px 30px"> <ellipse cx="46" cy="30" rx="4.5" ry="4" fill="#2d1b4e"/> <ellipse cx="47.5" cy="28.5" rx="1.5" ry="1.5" fill="white" opacity="0.8"/> <path d="M41.5 30 Q46 26.5 50.5 30" fill="none" stroke="#c8a882" stroke-width="1"/> </g> <polygon points="38,36 36,38.5 40,38.5" fill="#f4a0a0"/> <path d="M36,38.5 Q34,41 32,40" fill="none" stroke="#c8a882" stroke-width="1" stroke-linecap="round"/> <path d="M40,38.5 Q42,41 44,40" fill="none" stroke="#c8a882" stroke-width="1" stroke-linecap="round"/> <line x1="18" y1="36" x2="33" y2="38" stroke="#c8a882" stroke-width="0.8" opacity="0.7"/> <line x1="17" y1="39" x2="32" y2="39" stroke="#c8a882" stroke-width="0.8" opacity="0.7"/> <line x1="18" y1="42" x2="33" y2="40" stroke="#c8a882" stroke-width="0.8" opacity="0.7"/> <line x1="58" y1="36" x2="43" y2="38" stroke="#c8a882" stroke-width="0.8" opacity="0.7"/> <line x1="59" y1="39" x2="44" y2="39" stroke="#c8a882" stroke-width="0.8" opacity="0.7"/> <line x1="58" y1="42" x2="43" y2="40" stroke="#c8a882" stroke-width="0.8" opacity="0.7"/> <ellipse cx="28" cy="73" rx="7" ry="5" fill="#f5f0e8" stroke="#e0d8cc" stroke-width="0.8"/> <ellipse cx="44" cy="73" rx="7" ry="5" fill="#e8956d" stroke="#c97a52" stroke-width="0.8"/> <ellipse cx="25" cy="75" rx="2" ry="1.5" fill="#e0d8cc"/> <ellipse cx="28" cy="76" rx="2" ry="1.5" fill="#e0d8cc"/> <ellipse cx="31" cy="75" rx="2" ry="1.5" fill="#e0d8cc"/> <ellipse cx="41" cy="75" rx="2" ry="1.5" fill="#c97a52"/> <ellipse cx="44" cy="76" rx="2" ry="1.5" fill="#c97a52"/> <ellipse cx="47" cy="75" rx="2" ry="1.5" fill="#c97a52"/> </svg>`;
}
...
`<div id="bittu-bubble"> <div class="bubble-name">🐱 बिट्टू</div> मी नसले तरी पॉटर नेहमी तुझ्यासाठी आहे.<br> खूप अभ्यास कर, Luna.<br> नेहमी आनंदी राहा. 💜 <div class="bubble-heart">🧡</div> </div>`;
document.body.appendChild(wrap);

var examPeek = document.createElement(‘div’);
examPeek.id = ‘bittu-exam-peek’;
examPeek.innerHTML = buildBittuSVG() +
`<div id="bittu-exam-bubble"> <div class="exam-bubble-name">🐱 बिट्टू</div> वा Luna! खूप छान!<br>आता थांबू नकोस,<br>शेवटपर्यंत जा!<br>तू करू शकतेस! 💜 </div>`;
...
// ── PAPER SELECT: BITTU WALK ────────────────────────
var bittuShown = false;
var bittuTimers = [];

function clearBittuTimers() {
bittuTimers.forEach(function(t) { clearTimeout(t); });
bittuTimers = [];
}

// Hard reset — instant, no leftover state or half-visible bubble
function hardResetBittu() {
clearBittuTimers();
wrap.style.transition = ‘none’;  // kill transition so it jumps instantly
wrap.style.left = ‘-120px’;
wrap.style.display = ‘none’;
wrap.classList.remove(‘walking’, ‘sitting’, ‘walk-in’, ‘walk-out’);
var bubble = document.getElementById(‘bittu-bubble’);
if (bubble) bubble.classList.remove(‘show’);
// Re-enable transition after DOM settles
setTimeout(function() { wrap.style.transition = ‘’; }, 50);
bittuShown = false;
}
...
// Bubble visible for ~9.8s after sitting
bittuTimers.push(setTimeout(function () {
  var b = document.getElementById('bittu-bubble');
...
examPeekTimers.forEach(function(t) { clearTimeout(t); });
examPeekTimers = [];
}
...
```
// Always clean up exam peek when leaving exam
if (id !== 'exam-screen') {
  stopProgressWatch();
  hideExamPeek();
}
...
if (id === 'paper-select-screen') {
  hardResetBittu();            // clean any leftover state instantly
  showBlinkEyes(false);
  setTimeout(showBittu, 400); // trigger in 0.4s
}
